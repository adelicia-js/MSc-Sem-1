...
public final class StatsOps {
    ...
    private static void modeCalc(int[] arr) {
        ...
        System.out.println("The mode of "+size+" numbers is: "+mode+". It was repeated "+maxCount+" times.\n");
    }
    ...
    public static void main(String[] args) {
        ...
        for(int i=0; i<length; i++) {
            // parseInt() parses string arguments passed in the command line and returns integer values
