/*-------------------------------------------------------------------------
                                MaxMin.java
This program finds the minimum and maximum elements in an array of elements
...
public class MaxMin {
    ...
    private static int[] searchOp(int[] arr, int low, int high) {
        ...
        if (ind1 == ind2) { // arr.length = 1
            ...
            if (leftArray[0] < rightArray[0]) { // Comparing minimum elements of the 2 subarrays
            ...
            if (leftArray[1] > rightArray[1]) { // Comparing maximum elements of the 2 subarrays
    ...
    private static void printResult(int[] resultArr) {
        ...
        if (resultArr[0] == resultArr[1]) {
            ...
            System.out.println("The minimum element of the array is " + resultArr[0] + "!\n");
            System.out.println("The maximum element of the array is " + resultArr[1] + "!\n" + spacingLine);
        }
